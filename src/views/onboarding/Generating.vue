...
<template>
  <main class="device-shell bg-[#000] text-white">
    <div class="page-padding flex min-h-[100dvh] flex-col justify-between">
      <header class="pt-6">
        <p class="text-center text-[12px] text-white/48" style="letter-spacing: -0.12px">Zoopia 正在生成入场人格</p>
      </header>
      ...
      <section class="flex flex-1 flex-col items-center justify-center gap-10">
        <div class="relative flex h-28 w-28 items-center justify-center">
          ...
          <div class="absolute inset-[14px] rounded-full border border-white/10" />
          <div class="h-20 w-20 rounded-full border-[3px] border-white/14 border-t-[#0071e3] animate-[spin-smooth_1.2s_linear_infinite]" />
          <div class="absolute h-3 w-3 rounded-full bg-[#0071e3] shadow-[0_0_18px_rgba(0,113,227,0.75)]" />
        </div>

        <div class="space-y-3 text-center">
          <p class="text-[21px] font-normal" style="letter-spacing: 0.231px">正在建立你的情绪盲盒身份</p>
          <p class="min-h-6 text-[14px] text-white/62 transition-opacity duration-300" style="letter-spacing: -0.224px">
            {{ activeHint }}
          </p>
        </div>
      </section>
      ...
      <footer class="space-y-4">
        ...
        <div class="flex items-center justify-between text-[12px] text-white/48" style="letter-spacing: -0.12px">
          <span>解析中</span>
          <span>{{ progress }}%</span>
        </div>
      </footer>
