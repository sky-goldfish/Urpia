  ...
  <main class="device-shell">
    <div class="page-padding tabbar-padding flex min-h-[100dvh] flex-col gap-5">
      <header class="flex items-center justify-between">
        ...
        <span class="text-[12px] text-[#86868b]" style="letter-spacing: -0.12px">POI 详情</span>
      </header>

      <section class="rounded-[28px] bg-[linear-gradient(180deg,#edf4ff_0%,#ffffff_100%)] p-6 shadow-[rgba(0,0,0,0.18)_0px_22px_40px_0px]">
        <p class="text-[12px] text-[#86868b]" style="letter-spacing: -0.12px">{{ poi?.district }} · {{ poi?.distance }}</p>
      ...
      <section class="apple-card p-5">
        ...
        <div class="mt-4 grid gap-4 sm:grid-cols-2">
          <div class="rounded-[12px] bg-[#fafafc] p-4">
            <p class="text-[11px] text-[#86868b]" style="letter-spacing: -0.08px">当前氛围</p>
            <p class="mt-2 text-[17px] text-[#1d1d1f]" style="letter-spacing: -0.374px">{{ poi?.occupancy }}</p>
          </div>
          <div class="rounded-[12px] bg-[#fafafc] p-4">
            <p class="text-[11px] text-[#86868b]" style="letter-spacing: -0.08px">情绪提示</p>
