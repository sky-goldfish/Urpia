...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/map-entry', redirect: '/map' },
  { path: '/map-3d', name: 'map-3d', component: () => import('../views/explore/Map3DView.vue'), meta: { tab: 'explore' satisfies MainTabKey } },
  { path: '/poi/:id', name: 'poi-info', component: () => import('../views/explore/PoiInfo.vue'), meta: { tab: 'explore' satisfies MainTabKey } },
  { path: '/poi/:id/indoor', name: 'poi-indoor', component: () => import('../views/poi/indoor/POIIndoorView.vue'), meta: { tab: 'explore' satisfies MainTabKey } },
  ...
  { path: '/match', name: 'social-match', component: () => import('../views/social/SocialChatListPage.vue'), meta: { tab: 'social' satisfies MainTabKey } },
  { path: '/match/:id', name: 'social-chat-detail', component: () => import('../views/social/SocialChatDetailPage.vue'), meta: { tab: 'social' satisfies MainTabKey } },
